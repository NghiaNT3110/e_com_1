/* Lựa chọn các trường định vị đơn hàng (ID, trạng thái), nhân khẩu học, nguồn traffic từ các bảng thông tin - Select orders fields (Order ID, Order Status), demographic, traffic source */
